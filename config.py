...
def argps():
    ...
    # position embedding
    parser.add_argument("--position_embedding", help="whether to use position embedding", type=str2bool, default=1)
    parser.add_argument("--st_weight", type=float, default=0)
